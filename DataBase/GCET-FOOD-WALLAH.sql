CREATE DATABASE  IF NOT EXISTS `GCET-FOOD-WALLAH` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `GCET-FOOD-WALLAH`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: GCET-FOOD-WALLAH
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Pav Bhaji',25.00),(2,'Chole Bhature',40.00),(3,'Pizza',80.00),(4,'Mango Lassi',50.00),(5,'Masala Dosa',60.00),(6,'Vegetable Biryani',60.00),(7,'Vada Pav',50.00),(8,'Rava Dosa',70.00),(9,'Samosa',5.00),(10,'chai',15.00),(11,'pastry',35.00),(12,'Puri bhaji',40.00);
...
--
-- Dumping routines for database 'GCET-FOOD-WALLAH'
--
